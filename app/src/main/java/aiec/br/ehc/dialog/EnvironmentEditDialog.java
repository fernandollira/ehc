...
public class EnvironmentEditDialog extends Dialog implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TextView txtTitle = (TextView) findViewById(R.id.environment_dialog_title);
        ...
        txtParameter = (EditText) findViewById(R.id.environment_edit_parameter);
