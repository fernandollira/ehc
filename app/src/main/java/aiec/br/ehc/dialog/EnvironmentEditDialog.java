...
public class EnvironmentEditDialog extends Dialog implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final Spinner spinner = (Spinner) findViewById(R.id.environment_edit_icon);
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            case R.id.btn_yes:
                EditText txtName = (EditText) findViewById(R.id.environment_edit_name);
                EditText txtDescription = (EditText) findViewById(R.id.environment_edit_description);
                Spinner spinner = (Spinner)findViewById(R.id.environment_edit_icon);
